...
# colors for binding box visualization
...
app.layout = html.Div(className='container', children=[
    ...
    Row([html.P('Confidence Threshold:'),
        dcc.Slider(
...
def run_model(n_clicks, n_submit, iou, confidence, checklist, url):
    ...
    scores, boxes = filter_boxes(scores, boxes, confidence=confidence, iou=0.5, apply_nms=apply_nms)
    ...
    fig = pil_to_fig(im, showlegend=True, title=f'Predictions ({tend-tstart:.2f}s)')
